...
import com.bolsadeideas.springboot.di.app.models.service.IUploadFileService;
import com.bolsadeideas.springboot.di.app.util.paginator.PageRender;
...
public class ClienteController {
	...
	public ResponseEntity<Resource> verFoto(@PathVariable String filename) throws IOException {
		...
		return ResponseEntity.ok()
				.header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + recurso.getFile() + "\"")
				.body(recurso);
	}
	...
	private boolean hasRole(String role) {
		...
		// con esto sabemos cual es el role
